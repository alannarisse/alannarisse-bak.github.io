# Git, Github, Bash (unix command line)

## Linux Command Line
- [One hour tutorial on the linux Bash shell - Joe Collins](https://www.youtube.com/watch?v=oxuRxtrO2Ag)
- [online manual pages for linux](http://man.he.net/)
- [linux training - linux cheet sheet](https://www.linuxtrainingacademy.com/linux-commands-cheat-sheet/)
- [how to show/hide hidden files on mac](https://ianlunn.co.uk/articles/quickly-showhide-hidden-files-mac-os-x-mavericks/)
